...
def exibir_todas_as_saidas(funcionario):
    ...
    try:
        ...
        if len(listadesaidas)  == 0:
            return jsonify({'mensagem': 'Nenhuma saída cadastrada'}), 200  # OK
...
# Exibir todas as saídas de estoque para o funcionário logado
...
# Registrar uma nova saída de estoque
...
# Atualizar uma saída de estoque existente
...
# Excluir uma saída de estoque existente
